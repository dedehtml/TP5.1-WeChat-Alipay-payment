 ...
 * WxPay::WxPayJsApi($openId,$Body,$attach,$Out_trade_no,$Total_fee,$Goods_tag,$Notify_url,$Trade_type,$Product_id='')
 */
 ...
 * @return array|bool
 * WxPay::OrderQuery($transaction_id = '',$out_trade_no = '')
 */
 ...
 * @return array|bool
 * WxPay::ReFund($transaction_id = '',$out_trade_no = '',$total_fee='',$refund_fee = '')
 */
 ...
 * @return array|bool
 * WxPay::ReFundQuery($transaction_id = '',$out_trade_no = '',$out_refund_no='',$refund_id='')
 */
